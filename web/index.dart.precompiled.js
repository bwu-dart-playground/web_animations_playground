...
$=I.p
var $$={}
;init.mangledNames={gAN:"offsetParent",gAa:"_childElementCount",gEt:"scrollWidth",gHF:"outerHtml",gIN:"clientLeft",gIt:"clientHeight",gJZ:"offsetHeight",gMI:"previousElementSibling",gNa:"offsetLeft",gS:"style",gTa:"dropzone",gTq:"_innerHtml",gV5:"_attributes",gXr:"tabIndex",gd2:"contentEditable",gdC:"_children",geP:"scrollHeight",geQ:"translate",gfk:"scrollLeft",gjE:"spellcheck",gjO:"id",gke:"nextElementSibling",gld:"isContentEditable",gmd:"offsetWidth",gmk:"title",gnf:"hidden",gns:"tagName",gp3:"_xtag",grT:"_lastElementChild",gvR:"scrollTop",gvn:"_firstElementChild",gw8:"dir",gxD:"clientTop",gxr:"className",gyj:"draggable",gz3:"clientWidth",gzI:"offsetTop",gzd:"lang"};init.mangledGlobalNames={An:"selectStartEvent",BO:"_parseRange",Cu:"focusEvent",Dq:"submitEvent",EI:"mouseEnterEvent",Eb:"resizeEvent",GG:"dropEvent",GM:"touchStartEvent",Ht:"mouseOverEvent",Iu:"copyEvent",KD:"errorEvent",Ll:"beforeCopyEvent",Mv:"dragStartEvent",Od:"blurEvent",PN:"inputEvent",Pu:"mouseLeaveEvent",Rp:"abortEvent",Te:"pasteEvent",UG:"touchCancelEvent",Uc:"touchLeaveEvent",VY:"doubleClickEvent",WF:"touchEnterEvent",Xa:"mouseUpEvent",YM:"mouseDownEvent",YX:"loadEvent",Zd:"invalidEvent",au:"fullscreenErrorEvent",bU:"transitionEndEvent",bb:"contextMenuEvent",dE:"dragOverEvent",dm:"scrollEvent",hG:"touchMoveEvent",hK:"dragLeaveEvent",hq:"dragEnterEvent",i9:"mouseMoveEvent",iY:"selectEvent",jI:"changeEvent",lt:"_defaultValidator",nj:"searchEvent",qK:"clickEvent",qf:"mouseWheelEvent",rC:"keyUpEvent",rX:"beforeCutEvent",rz:"cutEvent",t2:"dragEndEvent",t3:"fullscreenChangeEvent",t4:"keyPressEvent",tT:"beforePasteEvent",to:"mouseOutEvent",ty:"_defaultSanitizer",wm:"dragEvent",xo:"_parseDocument",xq:"resetEvent",yI:"touchEndEvent",zm:"keyDownEvent"};(function (reflectionData) {
  "use strict";
...
"%":"Animation|DOMError|FileError|MediaError|MediaKeyError|Navigator|NavigatorUserMediaError|Player|PositionError|SQLError|SVGAnimatedNumberList|TimedItem|Timeline|Timing"},
kn:{
"^":"bool/Gv;",
...
for(z=0;z<a.length;++z)if(J.TS(a[z],b))return!0
return!1},
...
this.pa=b},
Wq:function(a,b){if(J.TS(b,2))init.globalState.Xz.Rk.NZ(new H.IY(this,new H.oU(a),"ping"))
else a.wR(null)},
...
return!!J.x(b).$isJM&&J.TS(this.JE,b.JE)},
...
n:function(a,b){if(b==null)return!1
return!!J.x(b).$isns&&J.TS(this.Ws,b.Ws)&&J.TS(this.Jz,b.Jz)&&J.TS(this.bv,b.bv)},
giO:function(a){var z,y,x
z=this.Ws
...
Av:{
"^":"Tp:0;c,d",
$0:function(){this.c.p9=null;--init.globalState.Xz.GL
this.d.$0()}},
ku:{
"^":"a;x6<",
...
$isvs:true,
$isb8:true,
static:{"^":"ew,Ry,C3,UX,NK",Dt:function(){return new P.vs(0,$.X3,null,null,null,null,null,null)},k3:function(a,b){b.Gv=2
...
return z},
Ou:[function(a,b){return J.TS(a,b)},"$2","iv",4,0,1],
T9:[function(a){return J.v1(a)},"$1","py",2,0,2],
...
ad:[function(a,b){return a==null?b==null:a===b},"$2","n0",4,0,3],
xv:[function(a){return H.CU(a)},"$1","J2",2,0,4],
...
$isa6:true,
static:{"^":"Wt,S4,dk,Lo,z2,b2,q9,IG,Do,Cv,kT,IJ,V6,Vk,S8,rG",xC:function(a,b,c,d,e,f){return new P.a6(a*86400000000+b*3600000000+e*60000000+f*1000000+d*1000+c)}}},
P7:{
"^":"Tp:39;",
...
a:{
"^":";",
n:[function(a,b){return this===b},"$1","gUJ",2,0,40,41,"=="],
giO:[function(a){return H.eQ(this)},null,null,1,0,42,"hashCode"],
bu:[function(a){return H.a5(this)},"$0","gCR",0,0,12,"toString"]},
"+Object":[],
Rn:{
"^":"a;vM<",
...
"^":"",
B9:function(a,b,c){var z=H.RB(b,"$isList",[P.Z0],"$aszM")
if(z||!1)z=!!J.x(a).$iscv||a==null
else z=!1
if(z)return new Animation(a,b,c)
z=H.RB(b,"$isList",[P.Z0],"$aszM")
if(z||!1){if(!!J.x(a).$iscv||a==null);z=!1}else z=!1
...
"%":"DOMException"},
cv:{
"^":"KV;p3:_xtag%-5,d2:contentEditable%-6,w8:dir%-6,yj:draggable%-7,nf:hidden%-7,ld:isContentEditable=-7,zd:lang%-6,jE:spellcheck%-7,Xr:tabIndex%-8,mk:title%-6,eQ:translate%-7,Ta:webkitdropzone%-6,V5:attributes=-9,xr:className%-6,It:clientHeight=-8,IN:clientLeft=-8,xD:clientTop=-8,z3:clientWidth=-8,jO:id%-6,Tq:innerHTML%-6,JZ:offsetHeight=-8,Na:offsetLeft=-8,AN:offsetParent=-5,zI:offsetTop=-8,md:offsetWidth=-8,HF:outerHTML=-6,eP:scrollHeight=-8,fk:scrollLeft%-8,vR:scrollTop%-8,Et:scrollWidth=-8,S:style=-10,ns:tagName=-6,ke:nextElementSibling=-5,MI:previousElementSibling=-5,Aa:childElementCount=-8,dC:children=-11,vn:firstElementChild=-5,rT:lastElementChild=-5",
bu:[function(a){return a.localName},"$0","gCR",0,0,12,"toString"],
...
throw H.b(P.u("Incorrect number or type of arguments"))},"$2","gtV",2,2,13,14,15,16,"animate"],
$iscv:true,
...
static:{"^":"qf<-17,bU<-18,xo@-19,BO@-20,lt@-21,ty@-22,Rp<-23,Ll<-23,rX<-23,tT<-23,Od<-23,jI<-23,qK<-24,bb<-24,Iu<-23,rz<-23,VY<-23,wm<-24,t2<-24,hq<-24,hK<-24,dE<-24,Mv<-24,GG<-24,KD<-23,Cu<-23,PN<-23,Zd<-23,zm<-25,t4<-25,rC<-25,YX<-23,YM<-24,EI<-24,Pu<-24,i9<-24,to<-24,Ht<-24,Xa<-24,Te<-23,xq<-23,Eb<-23,dm<-23,nj<-23,iY<-23,An<-23,Dq<-23,UG<-26,yI<-26,WF<-26,Uc<-26,hG<-26,GM<-26,t3<-23,au<-23"}},
"+Element":[27,28,29,30],
hY:{
"^":"ea;kc:error=",
"%":"ErrorEvent"},
...
"^":"PZ;",
bu:function(a){return a.toString()},
"%":"DOMWindow|Window"}}],["dart.isolate","dart:isolate",,P,{
"^":"",
IU:{
"^":"a;",
$isIU:true,
static:{N3:function(){return new H.ku((Math.random()*0x100000000>>>0)+(Math.random()*0x100000000>>>0)*4294967296)}}}}],["dart2js._js_primitives","dart:_js_primitives",,H,{
"^":"",
...
zW:{
"^":"Tp:43;a",
$2:function(a,b){this.a[a]=b}}}],["","file:///home/zoechi/source/my/dart/web_animations_playground/web/index.dart",,E,{
"^":"",
Iq:[function(){var z,y,x
z=J.x6(document.getElementById("target1"),[P.EF(["width","200px","backgroundColor","green","offset",0],null,null),P.EF(["width","1000px","backgroundColor","cyan","offset",1],null,null)],P.EF(["duration",2,"iterations",4,"fill","both"],null,null))
P.dT(P.xC(0,0,0,0,0,4),new E.em(z))
y=W.B9(document.getElementById("target2"),[P.EF(["backgroundColor","red","width","200px","offset",0],null,null),P.EF(["backgroundColor","purple","offset",0.3],null,null),P.EF(["backgroundColor","yellow","width","1000px","offset",1],null,null)],P.EF(["duration",2,"iterations",4,"fill","both"],null,null))
x=document.timeline.play(y)
P.dT(P.xC(0,0,0,0,0,4),new E.Lb(x))
P.dT(P.xC(0,0,0,0,0,6),new E.QA(x))},"$0","eE",0,0,0],
em:{
"^":"Tp:31;a",
$0:function(){this.a.specified.direction="reverse"}},
Lb:{
"^":"Tp:31;b",
$0:function(){this.b.source.specified.easing="steps(6, end)"}},
QA:{
"^":"Tp:31;c",
$0:function(){this.c.pause()}}},1],])
...
J.x6=function(a,b,c){return J.RE(a).XC(a,b,c)}
...
init.metadata=[{func:"X0",void:true},{func:"Gl",ret:J.kn,args:[null,null]},{func:"bX",ret:J.im,args:[null]},{func:"E0",ret:J.kn,args:[P.a,P.a]},{func:"ZY",ret:J.im,args:[P.a]},W.cv,J.O,J.kn,J.im,W.rh,W.oJ,[J.Q,W.KV],{func:"I6",ret:J.O},{func:"vj",ret:W.hg,args:[[J.Q,P.Z0]],opt:[null]},,"keyframes","timingInput",[W.Fk,W.J6],[W.Fk,W.Z2],W.Vb,W.u2,W.vD,W.MM,[W.Fk,W.ea],[W.Fk,W.Aj],[W.Fk,W.HL],[W.Fk,W.y6],W.KV,W.N4,W.dh,W.uE,{func:"NT"},{func:"bh",args:[null,null]},{func:"aB",args:[null]},{func:"TS",args:[null,J.O]},{func:"uO",args:[J.O]},{func:"BG",args:[null],opt:[null]},{func:"Uf",ret:J.kn},{func:"lv",args:[P.wv,null]},{func:"Pt",ret:J.O,args:[J.im]},{func:"wk",ret:J.kn,args:[null]},"other",{func:"cH",ret:J.im},{func:"Za",args:[J.O,null]},];$=null
...
if($desc instanceof Array)$desc=$desc[1]
cv.prototype=$desc
cv.prototype.gp3=function(receiver){return receiver._xtag}
cv.prototype.gp3.$reflectable=1
cv.prototype.sp3=function(receiver,v){return receiver._xtag=v}
cv.prototype.sp3.$reflectable=1
...
cv.prototype.gnf.$reflectable=1
cv.prototype.snf=function(receiver,v){return receiver.hidden=v}
cv.prototype.snf.$reflectable=1
cv.prototype.gld=function(receiver){return receiver.isContentEditable}
cv.prototype.gld.$reflectable=1
...
cv.prototype.gjE=function(receiver){return receiver.spellcheck}
cv.prototype.gjE.$reflectable=1
cv.prototype.sjE=function(receiver,v){return receiver.spellcheck=v}
cv.prototype.sjE.$reflectable=1
...
cv.prototype.gIt.$reflectable=1
...
cv.prototype.gTq=function(receiver){return receiver.innerHTML}
cv.prototype.gTq.$reflectable=1
cv.prototype.sTq=function(receiver,v){return receiver.innerHTML=v}
cv.prototype.sTq.$reflectable=1
...
cv.prototype.gAN.$reflectable=1
cv.prototype.gzI=function(receiver){return receiver.offsetTop}
cv.prototype.gzI.$reflectable=1
...
cv.prototype.geP.$reflectable=1
...
cv.prototype.gke=function(receiver){return receiver.nextElementSibling}
cv.prototype.gke.$reflectable=1
cv.prototype.gMI=function(receiver){return receiver.previousElementSibling}
cv.prototype.gMI.$reflectable=1
cv.prototype.gAa=function(receiver){return receiver.childElementCount}
cv.prototype.gAa.$reflectable=1
...
if($desc instanceof Array)$desc=$desc[1]
Lb.prototype=$desc
function QA(c){this.c=c}QA.builtin$cls="QA"
if(!"name" in QA)QA.name="QA"
$desc=$collectedClasses.QA
if($desc instanceof Array)$desc=$desc[1]
QA.prototype=$desc
return[qE,Gh,hg,fY,Mr,lJ,ct,nB,QP,IF,Ny,d7,HA,vH,xO,rV,Wy,QF,cm,Nh,cv,Fs,hY,ea,PZ,as,Aa,Yu,iG,mK,xf,Vb,ST,tb,pA,Mi,In,wP,eP,AL,Og,M6,El,mC,SV,ZY,Ee,Qb,xI,Q0,eY,KV,KY,G7,l9,Ql,wL,SN,HD,nK,rR,qj,KR,fs,j2,lp,kd,yN,Cp,HN,fq,h4,qk,GI,Tb,Iv,BT,yY,FB,ZH,X4,nS,FH,RH,lz,vw,aG,Oi,r0,yp,c1,Mq,Nf,Nc,Y0,ZJ,mU,eZ,IT,nV,ui,D6,DQ,Sm,xL,QU,es,jw,lv,pf,NV,W1,zo,wf,TU,ih,Nd,zp,Xu,lu,tk,me,oB,Ah,d4,MI,Ub,bM,eW,Qy,ju,OE,N9,BA,d0,tp,rE,PI,PQ,uz,Yd,p8,AD,Gr,Gq,GH,To,NJ,qI,jf,rQ,Lx,d5,hy,r8,aS,CG,UN,MT,Rk,Eo,Pe,UM,ZD,cu,BD,vR,Ja,zI,cB,LQ,yR,HP,fa,l4,Et,QS,Pi,qO,xt,tG,P0,Qm,FK,Gv,kn,YE,Ue,iC,is,Q,P,im,VA,O,PK,JO,O2,aX,oU,cC,RA,IY,JH,jl,Vg,Iy,JM,Ua,ns,yo,Bj,NO,II,fP,X1,HU,oo,OW,jP,AP,yH,FA,Av,ku,FD,Zr,W0,az,vV,Am,XO,dr,TL,KX,uZ,OQ,Tp,Bp,v,Eq,lb,tD,hJ,dC,wN,VX,a7,i1,xy,MH,Ca,Z5,D0,Pf,mJ,vs,da,pV,U7,rq,RW,YP,jZ,FZ,OM,fZ,TF,K5,pK,eM,R8,k6,oi,fG,EQ,YB,a1,db,i5,N6,jg,YO,oz,b6,tj,zQ,u3,mW,LG,Sw,o0,CL,a6,P7,DW,Ge,LK,AT,bJ,ub,ds,lj,UV,VS,t7,HG,kM,AC,Z0,c8,a,Rn,wv,IU,zW,em,Lb,QA]}